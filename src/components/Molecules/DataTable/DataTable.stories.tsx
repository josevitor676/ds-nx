...
const meta: Meta<typeof DataTable> = {
  ...
  argTypes: {
    columns: {
      description: "Definição das colunas. Cada coluna aceita `key`, `header`, `sortable`, `filterable`, `filterActive`, `onFilter`, `width` e `render`.",
      table: { type: { summary: "DataTableColumn[]" } },
      control: false,
    },
    data: {
      description: "Array de objetos com os dados das linhas. As chaves devem corresponder aos `key` das colunas.",
    ...
    selectable: {
      description: "Adiciona uma coluna de checkboxes para seleção individual e em massa. O estado é controlado externamente via `selectedRows` e `onRowSelect`.",
      control: "boolean",
      table: { type: { summary: "boolean" }, defaultValue: { summary: "false" } },
    },
    selectedRows: {
    ...
    onRowSelect: {
      description: "Callback chamado com os índices selecionados quando o usuário altera a seleção.",
      table: { type: { summary: "(selectedIndices: number[]) => void" } },
    },
    sortColumn: {
      description: "Chave da coluna ativamente ordenada (modo controlado). Quando fornecido, o componente não gerencia o estado de ordenação internamente.",
    ...
    onSort: {
      description: "Callback chamado com a chave da coluna e a nova direção quando o usuário clica no botão de ordenação.",
      table: { type: { summary: "(columnKey: string, direction: SortDirection) => void" } },
    },
    emptyState: {
      description: "Conteúdo exibido quando `data` está vazio.",
      table: { type: { summary: "ReactNode" }, defaultValue: { summary: '"Nenhum dado encontrado."' } },
      control: false,
    },
  },
  parameters: {
...
const people: Record<string, unknown>[] = [
  { name: "Ana Costa",   role: "Designer",    department: "Produto",     status: "Ativo",   progress: 75, active: true  },
  { name: "Bruno Lima",  role: "Engenheiro",  department: "Tecnologia",  status: "Ativo",   progress: 50, active: true  },
  { name: "Carla Souza", role: "Analista",    department: "Financeiro",  status: "Inativo", progress: 30, active: false },
  { name: "Daniel Melo", role: "Gerente",     department: "Produto",     status: "Ativo",   progress: 90, active: true  },
  { name: "Elisa Rocha", role: "Designer",    department: "Marketing",   status: "Inativo", progress: 20, active: false },
];
...
export const Default: Story = {
  ...
  parameters: {
    docs: { description: { story: "Tabela simples com colunas de texto e ordenação uncontrolled — o componente gerencia o estado de sort internamente." } },
  },
};
...
export const Striped: Story = {
  ...
  parameters: {
    docs: { description: { story: "Zebra striping — linhas ímpares recebem fundo `neutral-25` para facilitar a leitura em tabelas longas." } },
  },
};
...
export const Sortable: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Ordenação controlada. O estado de `sortColumn` e `sortDirection` é gerenciado externamente — útil quando a ordenação aciona uma chamada à API.",
      },
      source: {
...
export const Selectable: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Seleção de linhas controlada. A prop `selectable` adiciona a coluna de checkboxes. O estado é gerenciado externamente via `selectedRows` e `onRowSelect`.",
      },
      source: {
        code: `import { useState } from 'react';
...
export const WithCustomCells: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Células customizadas via prop `render` na definição de cada coluna. Recebe o valor bruto, o objeto da linha e o índice — permitindo renderizar qualquer componente do DS.",
      },
      source: {
...
export const Filterable: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Colunas com botão de filtro. O estado `filterActive` e o callback `onFilter` são definidos por coluna — o componente apenas sinaliza a intenção, a lógica de filtragem é externa.",
      },
      source: {
        code: `import { useState } from 'react';
import { DataTable } from '@/components';
...
export const Empty: Story = {
  ...
  parameters: {
    docs: { description: { story: "Estado vazio — exibido quando `data` é um array vazio. Use `emptyState` para customizar a mensagem." } },
  },
};
...
export const FullFeatured: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Exemplo completo com células customizadas, zebra striping e seleção de linhas simultâneos.",
      },
      source: {
        code: `import { useState } from 'react';
